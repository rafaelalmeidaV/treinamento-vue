...
const ModalLogin = defineAsyncComponent(() => import('../ModalLogin/modal_login_index.vue'))
const ModalAccountCreate = defineAsyncComponent(() => import('../ModalAccountCreate/modal_account_create_index.vue'))
